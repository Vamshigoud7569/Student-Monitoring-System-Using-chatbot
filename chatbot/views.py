...
def addinternship(request):
    ...
    InternshipModel(halticket_number=request.GET['username'],Company_Name=request.GET['company'],Project_title=request.GET['project'],From_date=request.GET['from_date'],To_date=request.GET['to_date']).save()
...
def viewstudentinternshipaction(request):
    ...
    if request.session['role']=="faculty":
        ...
        for internship in InternshipModel.objects.filter(halticket_number=username):
            ...
            print(internship.Project_title)
            print(internship.From_date)
            print(internship.To_date)
    ...
    try:
        ...
        if request.session['role'] in "faculty" or request.session['role'] in "admin":
            ...
            if "marks" in userText:
                ...
                return render(request, "chat.html", {"message": "Hi"})
